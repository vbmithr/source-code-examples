...
void ICACHE_FLASH_ATTR
UART_SetBaudrate(UART_Port uart_no, int baud_rate)
{
...
void ICACHE_FLASH_ATTR
UART_SetFlowCtrl(UART_Port uart_no, UART_HwFlowCtrl flow_ctrl, int rx_thresh)
{
...
void ICACHE_FLASH_ATTR
UART_ClearIntrStatus(UART_Port uart_no, uint32_t clr_mask)
{
    WRITE_PERI_REG(UART_INT_CLR(uart_no), clr_mask);
}

void ICACHE_FLASH_ATTR
UART_SetIntrEna(UART_Port uart_no, uint32_t ena_mask)
{
...
uart0_rx_intr_handler(void *para)
{
    ...
    * uart1 and uart0 respectively
    */
    UART_Port uart_no = UART0;//UartDev.buff_uart_no;
    int fifo_len = 0;
    int buf_idx = 0;
